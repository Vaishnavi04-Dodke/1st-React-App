...
// function column data
    ...
    function Card({ text }) {
      return (
        <Col className="cards col-md-4 p-4 text-center">
...
function Client({items ,index}){
    return(
        <Col key={index} className="mt-lg-0 mt-4">
...
<Client items={item} key={index}/>
      ...
      <Row className="d-grid gap-1 d-flex flex-wrap flex-md-nowrap flex-lg-nowrap p-0 m-0 small-cards mt-5 mb-5 mb-lg-0 mb-md-0 ">
